...
class MedicineDB: Object {
    ...
    @objc dynamic var pictureFilename: String = ""
    ...
    convenience init(medicine: Medicine, timeManager: TimeManagerProtocol = TimeManager()) {
        self.init(name: medicine.name,
                  ...
                  pictureFilename: medicine.pictureFilename ?? "",
    ...
    func getMedicine() -> Medicine {
        ...
        medicine.pictureFilename = self.pictureFilename.isEmpty ? nil : self.pictureFilename
        return medicine
    }
}
