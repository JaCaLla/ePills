...
protocol DBManagerProtocol {
    ...
    @discardableResult func update(medicine: Medicine, timeManager: TimeManagerProtocol) -> Result<Medicine, Error>
    ...
    @discardableResult func updateCyle(cycle: Cycle) -> Result<Cycle, Error>
