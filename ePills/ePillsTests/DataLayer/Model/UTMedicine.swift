...
class UTMedicine: XCTestCase {
    ...
    func testConstructorWhenPictureIsNil() {
        sut = Medicine(name: "asdfg",
                       unitsBox: 20,
                       intervalSecs: 8 * 3600,
                       unitsDose: 2,
                       medicinePictureFilename: nil)

        XCTAssertNil(sut.pictureFilename)
    }

    func testConstructorWhenPictureIsNotNil() {
        sut = Medicine(name: "asdfg",
                       unitsBox: 20,
                       intervalSecs: 8 * 3600,
                       unitsDose: 2,
                       medicinePictureFilename: "asdf")

        XCTAssertEqual(sut.pictureFilename, "asdf")
    }
